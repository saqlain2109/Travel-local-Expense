    ...
    return (
        <div className="max-w-6xl mx-auto py-8">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-2">Submit your expense claims with receipts for reimbursement approval.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm transition-colors">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Provide information about your expense claim</p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="col-span-1 md:col-span-2">
                                ...
                                <input
                                    ...
                                    type="text" className="w-full bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all placeholder:text-gray-400 dark:placeholder:text-gray-500" placeholder="Enter claim title"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        type="number" className="w-full bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg pl-10 pr-4 py-2.5 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all placeholder:text-gray-400" placeholder="0.00"
                                    />
                                </div>
                            </div>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Employee <span className="text-red-500">*</span></label>
                                <input disabled value={user?.name || 'Current User'} className="w-full bg-gray-50 dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-lg px-4 py-2.5 text-gray-500 dark:text-gray-300 outline-none cursor-not-allowed" />
                            </div>
                            ...
                            <div className="col-span-1 md:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <textarea
                                        ...
                                        rows="3" className="w-full bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg pl-10 pr-4 py-2.5 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all resize-none placeholder:text-gray-400" placeholder="Additional details..."
                                    ></textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm transition-colors">
                        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-1 flex items-center gap-2">
                            <Upload className="w-5 h-5 text-blue-600 dark:text-blue-400" /> Receipt Attachments
                        </h2>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Attach receipts to provide proof for your expense claim</p>

                        <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-10 flex flex-col items-center justify-center text-center hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer group bg-gray-50/50 dark:bg-gray-900/50">
                            <div className="w-14 h-14 rounded-full bg-blue-100/50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                                <Upload className="w-7 h-7" />
                            </div>
                            <h3 className="font-semibold text-gray-900 dark:text-white">Click to upload receipts</h3>
                            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Supported formats: Images (JPG, PNG) and PDF files</p>
                        </div>

                        <div className="mt-6 flex items-center gap-3">
                            <input type="checkbox" id="receipt-confirm" className="w-4 h-4 rounded border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-blue-600 focus:ring-blue-500" />
                            <label htmlFor="receipt-confirm" className="text-sm font-medium text-gray-700 dark:text-gray-300">I confirm that receipts are attached to this claim</label>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm sticky top-24 transition-colors">
                        <h3 className="font-semibold text-gray-900 dark:text-white mb-6 text-lg">Claim Summary</h3>

                        <div className="space-y-4 mb-8">
                            <div className="flex justify-between text-sm items-center">
                                <span className="text-gray-500 dark:text-gray-400">Title</span>
                                <span className="font-medium text-gray-900 dark:text-white text-right truncate w-32">{formData.title || '-'}</span>
                            </div>
                            <div className="flex justify-between text-sm items-center">
                                <span className="text-gray-500 dark:text-gray-400">Amount</span>
                                <span className="font-bold text-gray-900 dark:text-white text-lg">${formData.amount || '0.00'}</span>
                            </div>
                            <div className="flex justify-between text-sm items-center">
                            ...
                            <div className="flex justify-between text-sm items-center">
                                ...
                                <span className="inline-block px-2 py-1 rounded bg-gray-100 dark:bg-gray-700 text-xs font-semibold text-gray-600 dark:text-gray-300">{formData.category || '-'}</span>
                            </div>
                            <div className="border-t border-gray-100 dark:border-gray-700 pt-4 flex justify-between text-sm items-center">
                        ...
                        <div className="space-y-3">
                            ...
                            <button type="button" onClick={() => navigate(-1)} className="w-full bg-white hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-white border border-gray-200 dark:border-gray-600 font-medium py-3 rounded-lg transition-all">
                                Cancel
                            </button>
                        </div>

                        <div className="mt-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 text-xs text-blue-700 dark:text-blue-300 border border-blue-100 dark:border-blue-900/30 flex gap-2">
